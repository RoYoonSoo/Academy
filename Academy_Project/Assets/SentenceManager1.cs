...
public class SentenceManager1 : MonoBehaviour
{
    ...
    List<int> realAnswerNumbers = new List<int>() { 0, 7, 4, 5, 3, 1, 8, 9, 10, 11, 12, 14, 6, 2, 13 };// 진짜 답 
    ...
    private void RefreshDisplay()
    {
        ...
        if (Sentence.transform.childCount == 15) LogSortedChildNumbers();
    }
